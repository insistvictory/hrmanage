    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("select").blur(function () {
                ...
                var str=""
                $.ajax({
                    url:"${pageContext.request.contextPath}/employee/lookSalaryByTime",
                    type:"post",
                    dataType:"json",
                    data:{"time":$(this).val(),eid:${requestScope.eid}},
                    success:function(data){
                            str+="<tr>"+
                                +"<td>"+this.sumSalary+"</td>"
                                +"<td>"+this.baseSalary+"</td>"
                                +"<td>"+this.rewardSalary+"</td>"
                                +"<td>"+this.society+"</td>"
                                +"<td>"+this.argSalary+"</td>"
                                +"</tr>";
